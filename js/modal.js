const galleries = [
    ...
    document.querySelectorAll("img.third-g-img"),
    document.querySelectorAll("img.fourth-g-img")
];
...
const navP = document.querySelector('p.nav-p');
const navA = document.querySelector('a.nav-a');
